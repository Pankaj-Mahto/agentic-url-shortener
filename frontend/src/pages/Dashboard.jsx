...
import { LogOut, Sparkles, X, BarChart3, RefreshCw, Link2 } from "lucide-react";
...
export default function Dashboard() {
  ...
  const handleAnalytics = async (linkId) => {
    ...
    try {
      ...
      console.log("🔍 Requesting analytics for link ID:", linkId);
      ...
      <header className="sticky top-0 z-50 bg-white/70 backdrop-blur-xl border-b border-white/30 shadow-lg">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <button
            ...
            className="group flex items-center gap-2 px-6 py-2.5 bg-gradient-to-r from-rose-500 to-rose-600 text-white font-medium rounded-xl shadow-lg hover:shadow-xl hover:from-rose-600 hover:to-rose-700 transition-all duration-300 transform hover:scale-[1.03]"
          >
      ...
      <main className="max-w-7xl mx-auto px-6 py-10 md:py-12">
        ...
        {selectedLink && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            <div className="absolute inset-0 bg-black/60 backdrop-blur-sm" onClick={closeAnalytics} />

            <div
              className="relative w-full max-w-4xl max-h-[92vh] overflow-y-auto bg-white/95 backdrop-blur-2xl border border-white/50 rounded-3xl shadow-2xl p-8 sm:p-12"
            ...
            >
              ...
              <div className="flex items-center gap-5 mb-10">
                ...
                <div className="min-w-0 flex-1">
                  <h2 className="text-3xl font-bold bg-gradient-to-r from-indigo-800 to-purple-900 bg-clip-text text-transparent truncate">
                    /{selectedLink.shortCode || selectedLink._id?.slice(-8) || "link"}
                  </h2>
                  <p className="text-gray-600 mt-2 truncate font-medium">
              ...
              {analyticsLoading ? (
                ...
                <div className="bg-gradient-to-r from-red-50 to-rose-50 border border-red-200 p-10 rounded-2xl text-center my-12">
                  <p className="text-xl font-semibold text-red-800 mb-4">Analytics Error</p>
                  <p className="text-red-700 mb-8">{analyticsError}</p>
                  <button
                    onClick={() => handleAnalytics(selectedLink._id)}
                    className="inline-flex items-center gap-3 px-8 py-4 bg-red-600 text-white font-semibold rounded-xl hover:bg-red-700 transition-all"
                  >
                    <RefreshCw size={20} />
                    Try Again
                  </button>
                ...
                <div className="space-y-12">
                  ...
                  <div className="bg-gray-50 p-6 rounded-2xl border">
                    <h4 className="text-lg font-semibold mb-4">Raw Analytics Data</h4>
                    <pre className="bg-gray-900 text-gray-100 p-5 rounded-xl overflow-auto text-sm max-h-96 font-mono whitespace-pre-wrap break-all">
                ...
                <div className="text-center py-20 text-gray-600">
                  ...
                  <p className="text-2xl font-semibold text-gray-800">No analytics data yet</p>
                  <p className="mt-3">Share your short link to start collecting clicks</p>
                </div>
              )}
            </div>
          </div>
...
function StatBox({ label, value, color }) {
  ...
  return (
    <div className={`p-8 rounded-2xl border bg-gradient-to-br ${colors[color]} shadow-lg hover:shadow-xl transition-all`}>
